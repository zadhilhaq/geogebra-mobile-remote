...
import 'package:aygeoge/pages/materi/refleksi/refleksi2.dart';
import 'package:aygeoge/pages/menu/view/menu.dart';
import 'package:flutter/material.dart';
import 'package:url_launcher/url_launcher.dart';

class Refleksi3 extends StatelessWidget {
  @override
                        ...
                        child: Column(
                          children: [
                            Center(
                              child: Image(
                                image:
                                    AssetImage("assets/images/refleksi3.png"),
                                width: 300,
                              ),
                            ),
                            Center(
                              child: TextButton(
                                ...
                                onPressed: () => _launchURL(
                                    'https://drive.google.com/file/d/1gtMBrThdJyCAxz_B3Vrj2U1Wtw4EF_CI/view?usp=sharing'),
                                child: const Text(
                                    'https://drive.google.com/file/d/1gtMBrThdJyCAxz_B3Vrj2U1Wtw4EF_CI/view?usp=sharing'),
                              ),
                            )
